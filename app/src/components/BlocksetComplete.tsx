    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
      ...
      <div className="bg-[#1e1e2e] border border-[#313244] rounded-2xl p-8 max-w-sm w-full mx-4 text-center relative z-10">
        ...
        <div className={`mb-4 transition-all duration-500 ${showCheck ? 'scale-100 opacity-100' : 'scale-50 opacity-0'}`}>
          <div className="w-16 h-16 mx-auto rounded-full bg-[#a6e3a1]/20 flex items-center justify-center">
            <svg className="w-10 h-10 text-[#a6e3a1]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
            </svg>
          </div>
        </div>

        <h2 className="text-2xl font-bold text-[#cdd6f4] mb-2">Blockset Complete!</h2>
        <p className="text-sm text-[#6c7086] mb-6">Great work following the instructions!</p>
