    ...
    <div className="flex flex-col h-full bg-crust">
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-mantle border-b border-surface-0">
        <div className="flex items-center gap-2">
          ...
          {isRunning && (
            <span className="text-xs text-warn animate-pulse">Running...</span>
          )}
        </div>
        {result && !isRunning && (
      ...
      {activeTab === 'console' && (
        <div className="flex-1 overflow-auto p-4 font-mono text-sm">
          {!isRunning && !result && lines.length === 0 && (
            <div className="text-overlay italic">
          ...
          {result && !isRunning && result.error && (
            <div className="mt-2 text-danger bg-danger/10 rounded-lg p-3">
      ...
      <div
        className={`flex-1 overflow-auto p-4 items-center justify-center bg-base ${
      ...
      >
        <canvas
          ...
          width={640}
          height={400}
          className="max-w-full max-h-full rounded-lg shadow-lg border border-surface-0 bg-crust"
      ...
      {activeTab === 'preview' && (
        <div className="flex-1 overflow-hidden">
          {hasHtml && previewCode ? (
            ...
            <div className="flex items-center justify-center h-full text-overlay italic text-sm">
