...
const translations: Record<string, Record<string, string>> = {
  es: {
    ...
    'Configure how CryptoBlocks behaves.': 'Configura cómo funciona CryptoBlocks.',
    'Automatically save a checkpoint at regular intervals': 'Guardar un punto automáticamente a intervalos regulares',
