...
const NODES: Node[] = [
  ...
  { id: 'ref-canit', label: '"Can it run DOOM?" — tech industry meme', type: 'reference', depth: 3 },
  { id: 'ref-id', label: 'id Software', type: 'reference', depth: 4 },
...
const EDGES: Edge[] = [
  ...
  { from: 'cmd-doom', to: 'ref-canit', label: '"can it run DOOM?"' },
  { from: 'ref-canit', to: 'ref-id' },
  { from: 'ref-canit', to: 'ref-carmack' },
