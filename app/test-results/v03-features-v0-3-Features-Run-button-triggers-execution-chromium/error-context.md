...
- Name: v03-features.spec.ts >> v0.3 Features >> Run button triggers execution
- Location: e2e/v03-features.spec.ts:114:3
...
Call log:
  - waiting for locator('button').filter({ hasText: 'Run' })
    - locator resolved to <button class="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-lg transition-colors bg-[#a6e3a1] text-[#1e1e2e] hover:bg-[#a6e3a1]/80 font-semibold px-3 md:px-4">…</button>
