---
title: 'Learn'
PageTitle: 'Learn to Code with CryptoBlocks'
description: 'Tutorials, guides, and resources for learning to code with CryptoBlocks. From your first block to writing your own.'
priority: 0.8
---
...
The best way to learn is to [open CryptoBlocks](https://app.getcryptoblocks.com) and start dragging blocks. Hit Peek Code to see what each block does. Hit Run to see it execute. Break things. That's how you learn.
